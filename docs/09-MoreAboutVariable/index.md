...
* 詳しくはこれ見てください  
> [浮動小数点数 - Wikipedia](http://ja.wikipedia.org/wiki/%E6%B5%AE%E5%8B%95%E5%B0%8F%E6%95%B0%E7%82%B9%E6%95%B0)
...
* 型名ではなく、変数名を入れてもよい。
* integerSizeにはint型のメモリサイズ、4が入る
* <small>変数名の場合、`()`を書かなくても良い。逆に型名のときは必須なので注意。</small>
...
* 具体的な初期値を与えなかった場合、必ず 0 で初期化される。
* ローカル変数も同じく、宣言より先にアクセスすることは基本的に出来ない
  * ただし、後述のアクセス指定子`extern`を利用することでアクセスできるようになる。
