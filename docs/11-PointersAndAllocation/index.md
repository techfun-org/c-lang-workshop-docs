...
psの 間接参照先（指し示す先）の x へアクセスする。

	ps->x

----
#### 例2
Humanのメンバはchar name[20], int height, int weightとする。
...
* こう書くと、xの関節参照先ではなく、xそのものを書き換えできなくなる。
